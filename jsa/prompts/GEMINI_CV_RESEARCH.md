...
## What to do
1. If a job posting link is given, use your web search and fetch tools to retrieve its content.
2. Search the company name to find their main website; fetch the homepage and/or "About" page.
